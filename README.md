...
The robot's field is 6 cells long and 5 cells wide. It has blue walls around the perimeter. 
...
The solution of the task is located in the file "Task-6-4.py".


RobotTask-6-4. Занятия по Python. Исполнитель Робот. Платформа StepInDev. Приложение с графическим интерфейсом пользователя.
Поле робота имеет размеры: длина 6 клеток, ширина 5 клеток. Оно имеет синие стены по периметру. 
Синим квадратом помечено начальное положение робота. Конечное положение робота помечено красным домиком. 
Закрашенные клетки поля помечены большим оранжевым квадратом. 
...
Решение задачи находится в файле "Task-6-4.py".



Robot Pos N1

<img width="545" height="416" alt="изображение" src="https://github.com/user-attachments/assets/10e3cbd9-4f63-466e-a0bf-4fe32c90d51e" />

Robot Pos N2

<img width="555" height="409" alt="изображение" src="https://github.com/user-attachments/assets/392e8949-0400-4fd2-97e6-d8dd68e05e8a" />
